...
SmartWerk 1.2.20 WP3DPrinting scope fix
---------------------------------------
- keeps the existing dequeue-based WP3DPrinting asset scoping
- additionally filters final script/style loader tags from /plugins/3dprint/ outside the real configurator context
- WP3DPrinting remains fully loaded on page 1636 and product 783
- normal WooCommerce product pages no longer receive Three.js, STL/OBJ/DXF loaders, Plupload, PrettyPhoto and other WP3DPrinting frontend assets
- no pricing, product, variation, cart or checkout logic changes
