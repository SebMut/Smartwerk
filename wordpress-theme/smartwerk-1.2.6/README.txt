SmartWerk WordPress Theme 1.2.6
================================
...
2. smartwerk-theme-1.2.6.zip auswählen
3. Installieren
...
SmartWerk 1.2.6 migration layer
-------------------------------
...
SmartWerk 1.2.6 proof-layout fix
-------------------------------
...
SmartWerk 1.2.6 safe performance baseline
-----------------------------------------
...
SmartWerk 1.2.6 product detail pages
------------------------------------
