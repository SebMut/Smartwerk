...
function smartwerk_assets(): void {
    ...
    wp_script_add_data('smartwerk-theme', 'strategy', 'defer');
...
function smartwerk_performance_head(): void {
...
add_action('wp_head', 'smartwerk_performance_head', 2);
...
function smartwerk_dequeue_guest_dashicons(): void {
    if (!is_user_logged_in()) {
        wp_dequeue_style('dashicons');
    }
}
add_action('wp_enqueue_scripts', 'smartwerk_dequeue_guest_dashicons', 100);
