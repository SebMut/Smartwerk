SmartWerk WordPress Theme 1.2.2
================================
...
2. smartwerk-theme-1.2.2.zip auswählen
3. Installieren
...
SmartWerk 1.2.2 migration layer
-------------------------------
...
SmartWerk 1.2.2 proof-layout fix
-------------------------------
...
SmartWerk 1.2.2 performance
---------------------------
- all homepage content images use native lazy loading and async decoding
- hero image is preloaded on the front page for faster LCP
- Manrope is enqueued separately instead of CSS @import
- Google Fonts origins receive preconnect hints
- SmartWerk JavaScript is deferred
- WordPress emoji frontend overhead is removed
- Dashicons are not loaded for logged-out visitors
- WooCommerce and WP3DPrinting assets remain untouched for compatibility
